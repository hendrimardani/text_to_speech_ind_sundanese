...
def proses(text, jk, output, sample_rate):
    if jk == 1:
        ...
        AudioSegment.from_wav(output + "Pria" + str(sample_rate) + ".wav").export(output +"Pria" + str(sample_rate) + ".mp3", format="mp3")
    else:
        ...
        AudioSegment.from_wav(output + "Wanita" + str(sample_rate) + ".wav").export(output +"Wanita" + str(sample_rate) + ".mp3", format="mp3")
